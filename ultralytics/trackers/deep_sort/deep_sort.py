...
from ultralytics.trackers.deep_sort.sort.nn_matching import NearestNeighborDistanceMetric
from ultralytics.trackers.deep_sort.sort.preprocessing import non_max_suppression
from ultralytics.trackers.deep_sort.sort.detection import Detection
from ultralytics.trackers.deep_sort.sort.tracker import Tracker
from ultralytics.paddle.paddle_pplcnetv2 import PPLCNetv2Predictor as Extractor
__all__ = ['DeepSort']
